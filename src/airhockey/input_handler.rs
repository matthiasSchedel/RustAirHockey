...
impl InputHandler {
  ...
  pub fn get_target_position(
    ...
    let filtered_touches =
      self.filter_touches_for_player(half_x_min, half_x_max, self.input.get_touch_positions());
